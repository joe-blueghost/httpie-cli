...
- Added `--save` flag to save the response body to an auto-named file while preserving normal terminal output.
- Added `--save-dir` flag to specify the output directory for `--save`.
